package xyz.abc.product.composite.services;
...
import xyz.abc.api.composite.product.ProductAggregate;
import xyz.abc.api.composite.product.ProductCompositeService;
import xyz.abc.api.composite.product.RecommendationSummary;
import xyz.abc.api.composite.product.ReviewSummary;
import xyz.abc.api.composite.product.ServiceAddresses;
import xyz.abc.api.core.product.Product;
import xyz.abc.api.core.recommendation.Recommendation;
import xyz.abc.api.core.review.Review;
...
// LOG.debug("getCompositeProduct: lookup a product aggregate for productId:
// {}", productId);
